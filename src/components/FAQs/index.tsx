			...
			<Accordion allowMultiple margin={'0 auto'} style={{ width: '100%', maxWidth: '600px' }}>
				...
				<AccordionItem>
					<h2>
						<AccordionButton>
							<Box flex="1" textAlign="left">
								Does SeaPort take any fees?
							</Box>
							<AccordionIcon />
						</AccordionButton>
					</h2>
					<AccordionPanel pb={4}>
						SeaPort takes 0 fee on swaps.
						<br />
						<br /> You'll get the exact same price swapping through SeaPort as what you'd get swapping through the
						...
						of it is shared with SeaPort. We also integrate aggregators with no fee sharing the best price, and in
				...
				<AccordionItem>
					<h2>
						<AccordionButton>
							<Box flex="1" textAlign="left">
								Will I be eligible for aggregator airdrops if I swap through SeaPort?
							</Box>
							<AccordionIcon />
						</AccordionButton>
					</h2>
					<AccordionPanel pb={4}>
						...
						executed directly from their UI and a swap executed from SeaPort.
						<br />
						<br />
